...
echo "  ~~~~~~~~~~~~~~~~~~~~~ Mys-Tool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        ...
        echo " [x] ✔ Exit                  [h] ✔ Help" 
        echo ""
        echo -ne "❨${red}Mys-tool@Mys${tp}❩:(${blue}./mys-tool${tp})\n↳[${blink}${lightcyan}*${tp}]➢ " ; read option
        ...
        case "$option" in 
            ...
            if [[ -d torghost ]] ; then
                ...
                echo -e $red "~~~~~~~~~~~~~~~ Mys-Oto-İp İndiriliyor ~~~~~~~~~~~~~~~"
                git clone https://github.com/Mys-tool/oto-ip > /dev/null 2>&1
                spinlong
                cd oto-ip
                echo -e $red "~~~~~~~~~~~~~~~ Ek Bileşenler Kuruluyor ~~~~~~~~~~~~~~~$tp"
                {
            ...
            while :; do
                ...
                echo -e "b-) Ana Menü"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-tool${red}]─[${green}./mys-tool.sh/PhoneInfoga${red}] \n└──╼${yellow}$ ${tp}" ; read input1
                if [[ $input1 = "1" ]] ; then
                echo -e "${green}[TR +${red}90${green}]${tp} +90 yazmadan ${blue}5312534783${tp} şeklinde giriniz"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-tool${red}]─[${green}./mys-tool.sh/PhoneInfoga/TR${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
                ...
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-tool${red}]─[${green}./mys-tool.sh/PhoneInfoga/custom${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
